    ...
    >
      <li v-for="team in teamsByName" :key="team.id">
            ...
            >
              <div class="truncate">
                <div class="flex items-center text-sm">
                  ...
                  <a
                    href="#"
                    class="ml-2 text-sm text-danger-500 focus:outline-none hover:text-danger-600 md:hidden md:group-hover:block"
        ...
        <div v-show="teamContentIsVisible[team.id]" class="px-4 py-4 sm:px-6">
          ...
          <p
            class="mb-2 text-sm font-medium text-neutral-800 dark:text-neutral-200"
